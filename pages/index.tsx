  ...
  return (
    <div
     className="bg-lightBackground text-darkBlack dark:bg-darkBackground dark:text-white h-screen snap-y snap-mandatory
      overflow-y-scroll overflow-x-hidden z-0 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-darkGreen/80 transition-all duration-300"
    >
      <Head>
        <link
        ...
        <title>{"Lalitha's Portfolio"}</title>
      </Head>
