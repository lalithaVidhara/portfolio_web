...
export default function WorkExperience({ experiences }: Props) {
  return (
    ...
    >
      <h3 className="absolute top-20 md:top-30 uppercase tracking-[20px] text-gray-500 text-xl md:text-2xl ml-10">
        My Journey
        <h3 className="absolute uppercase tracking-[0px] left-1 md:left-3 text-gray-500 text-sm md:text-sm">
